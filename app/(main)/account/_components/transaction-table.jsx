...
import { ChevronDown, ChevronUp, Clock, Edit2Icon, HamburgerIcon, MoreHorizontal, RefreshCw, SearchIcon, Trash, TrashIcon, X } from "lucide-react";
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            ...
            <div>
              <Button variant="destructive" size="sm" onClick={handleBulkDelete} suppressHydrationWarning>
        ...
        <div className="container mx-auto px-4 rounded-md border">
          {/* Transaction */}
          <Table>
            <TableHeader>
              <TableRow>
                  ...
                  <TableRow key={transaction.id}>
                    ...
                    <TableCell>
                      {transaction.isRecurring ? (
                        ...
                        <Badge variant="outline" className="gap-1 text-bold">
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent suppressHydrationWarning>
                          <DropdownMenuItem
                            className="flex gap-2 items-center justify-start cursor-pointer hover:bg-gray-100"
                            onClick={() =>
                              router.push(
                            ...
                            suppressHydrationWarning
                          >
                            <Edit2Icon className="h-4 w-4 text-blue-400" />
                            Edit
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            className="flex gap-2 items-center justify-start cursor-pointer hover:bg-gray-100"
